...
export function Header() {
  ...
  const menuNav = isHome ? homeNav : nav;
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className={`link-underline inline-flex items-center gap-1.5 text-[13px] font-medium tracking-wide transition-colors ${
                        active ? "text-brass-deep" : "text-ink/75 hover:text-ink"
                      }`}
                    >
                      {item.label}
                      <Icon
                    ...
                    <div className="invisible absolute left-1/2 top-full z-40 w-[34rem] max-w-[calc(100vw-3rem)] -translate-x-1/2 translate-y-1 border border-ink/10 bg-paper p-4 opacity-0 shadow-[0_24px_60px_-34px_rgba(18,16,10,0.5)] transition-all duration-300 group-hover/mega:visible group-hover/mega:translate-y-0 group-hover/mega:opacity-100 group-focus-within/mega:visible group-focus-within/mega:translate-y-0 group-focus-within/mega:opacity-100">
